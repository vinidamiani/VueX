<template>
    <div id="desafio">
        <!-- 1) Ligue o boãto para alternar a exibição dos dois
        ...
        <h2>#02</h2>
        <ul>
            <li v-for="(nome, i) in nomes" :key="nome.id">{{ nome }} - {{ i }}</li>
        </ul>
        ...
        <h2>#03</h2>
        <ul>
            <li v-for="(valor, chave, indice) in livro" :key="valor.id">
                {{ chave }}: {{ valor }} - {{ indice + 1 }}
            </li>
        </ul>
        ...
        <h2>#04</h2>
        <ul>
            <li v-for="valor in aluno" :key="valor.id">
                ...
                <template v-else>
                    Notas:
                    <ul>
                        <li v-for="nota in valor" :key="nota.id">{{ nota }}</li>
                    </ul>
                </template>
            </li>
        </ul>
